...
import com.pran.model.UserCredentials;
...
public class JwtUsenameAndPasswordAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	...
	public JwtUsenameAndPasswordAuthenticationFilter(AuthenticationManager authManager, JwtConfig jwtConfig) {
		super();
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			UserCredentials cred = new ObjectMapper().readValue(request.getInputStream(), UserCredentials.class);
			...
			UsernamePasswordAuthenticationToken authToken = new UsernamePasswordAuthenticationToken(cred.getUsername(),
					cred.getPassword(), Collections.emptyList());
